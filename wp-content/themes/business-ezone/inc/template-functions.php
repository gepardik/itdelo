                        ...
                        $qry->the_post();
                            ...
                            <div class="item">
                                ...
                                if( has_post_thumbnail() ){ 
                                    ...
                                    echo '<img src="'. esc_url( get_template_directory_uri() ).'/images/banner3.png">';
                                } 
                                        if( $slider_caption ){ ?>
                                        ...
                                        ?>
                                            <div class="col-6">
                                                <div class="skill-item">
                                                    ...
                                                    <a href="<?php the_permalink(); ?>" class="btn blue"><?php esc_html_e( 'Подробнее','business-ezone' );?></a>
                                                </div>
                                            </div>
                                        <?php
                                        }
    ...
    echo '<div class="footer-b">';
        echo '<div class="container">'; 
            echo '<div class="site-info">';
                ...
                printf( '&nbsp;%s', '<a href="'. esc_url( __( 'http://www.kunstnik.com', 'business-ezone' ) ) .'" target="_blank">'. esc_html__( 'kunstnik.com. ', 'business-ezone' ) .'</a>' );
